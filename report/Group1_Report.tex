...
exceeds GitHub's 100\,MB limit and is regenerated locally by the data pipeline; the
analytics pages that need the full population rebuild it on first run.
\end{keybox}
...
is rebuilt locally), point Streamlit Cloud at
