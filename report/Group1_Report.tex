...
\begin{todobox}
\textbf{Remaining for submission.} Attach Overview and Live Feed page screenshots to the appendix.
\end{todobox}
...
in currency, and watches itself for drift - closing the loop the brief asks for. With the
live application now published, the sole remaining task is to attach the demo screenshots to
the appendix.
